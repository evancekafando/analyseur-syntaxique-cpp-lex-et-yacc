...
{
       0,   138,   138,   142,   145,   146,   149,   150,   151,   152
};
#endif
...
{
  "$end", "error", "$undefined", "NOMBRE", "IDENT", "'('", "')'", "'+'",
  "'-'", "'*'", "'/'", "'\\n'", "$accept", "liste_expr", "expr", YY_NULLPTR
};
#endif
